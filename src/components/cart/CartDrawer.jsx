      ...
      {isCartOpen && (
        <div className="fixed inset-0 z-[100] flex justify-end">
          ...
          <motion.aside
            ...
            className="relative ml-auto w-full max-w-[340px] sm:max-w-[380px] md:max-w-md h-full bg-wbk-white shadow-2xl flex flex-col z-10 font-poppins border-l border-wbk-lightgrey overflow-hidden"
          >
            {/* Drawer Header */}
            <div className="flex items-center justify-between px-4 sm:px-6 py-4 border-b border-wbk-lightgrey/70 bg-[#FBF9F8]">
            ...
            <div className="px-4 sm:px-6 py-2.5 bg-[#F4F2F0] border-b border-wbk-lightgrey/50 flex items-center gap-2 text-xs text-wbk-brown">
            ...
            {/* Cart Items List */}
            <div className="flex-1 overflow-y-auto px-4 sm:px-6 py-4 space-y-4 custom-scrollbar divide-y divide-wbk-lightgrey/40">
              {items.length === 0 ? (
            ...
            {items.length > 0 && (
              <div className="p-4 sm:p-6 border-t border-wbk-lightgrey/70 bg-[#FBF9F8] space-y-4">
                {/* Subtotal summary */}
