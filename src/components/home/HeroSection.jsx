        ...
        <div className="relative z-10 flex h-full flex-col justify-between py-12 pointer-events-none">
          ...
          <Container className="flex flex-col items-center text-center">
            ...
            >
              ...
              <p className="text-sm sm:text-base text-wbk-brown max-w-lg mx-auto leading-relaxed">
                Space-saving, handcrafted wall beds engineered for seamless everyday living.
              ...
              <div className="pt-2 flex flex-wrap items-center justify-center gap-4 pointer-events-auto">
                <Button as="link" href="/products/beds" size="lg" className="shadow-md">
                  Shop Collection
                </Button>
                <Button as="link" href="/about" variant="secondary" size="lg" className="bg-wbk-white/80 backdrop-blur-md">
                  Explore Models
                </Button>
              </div>
            </motion.div>
