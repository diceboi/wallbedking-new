    ...
    <div className="bg-wbk-white min-h-screen pt-12 pb-24 font-poppins">
      ...
      <Container size="xl" className="pt-14 sm:pt-18">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16">
          ...
          <div className="lg:col-span-5 space-y-8">
            <div>
              ...
              <div className="space-y-4">
                {/* Telephone */}
                <div className="p-5 rounded-2xl border border-wbk-lightgrey bg-white flex items-start gap-4 shadow-2xs">
                  <div className="w-10 h-10 rounded-xl bg-[#F4F2F0] text-wbk-black flex items-center justify-center shrink-0">
            ...
            <div className="p-6 rounded-3xl border border-wbk-lightgrey bg-[#FBF9F8] space-y-4">
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-xl bg-wbk-black text-white flex items-center justify-center shrink-0">
          ...
          <div className="lg:col-span-7">
            <div className="bg-white p-8 sm:p-10 rounded-3xl border border-wbk-lightgrey shadow-sm">
              ...
              {submitted ? (
                <div className="py-12 px-6 text-center bg-[#F4F2F0]/60 rounded-2xl border border-wbk-lightgrey/80">
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                    <div>
                      ...
                      <input
                        ...
                        className="w-full h-11 px-4 text-xs bg-[#FBF9F8] border border-wbk-lightgrey rounded-xl text-wbk-black focus:outline-none focus:border-wbk-black transition-colors"
                      />
                    </div>
                    <div>
                      <label className="block text-xs font-medium text-wbk-black mb-1.5">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                    ...
                    <div>
                      ...
                      <select
                        ...
                        className="w-full h-11 px-3 text-xs bg-[#FBF9F8] border border-wbk-lightgrey rounded-xl text-wbk-black focus:outline-none focus:border-wbk-black transition-colors"
                      >
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      className="w-full p-4 text-xs bg-[#FBF9F8] border border-wbk-lightgrey rounded-xl text-wbk-black focus:outline-none focus:border-wbk-black transition-colors"
                    />
                  </div>
      ...
      <section className="mt-20 border-t border-wbk-lightgrey/60 pt-16">
        <Container size="xl">
          ...
          <div className="w-full aspect-[21/9] min-h-[350px] rounded-3xl overflow-hidden border border-wbk-lightgrey/80 shadow-xs">
            <iframe
