      ...
      <Container size="md" className="max-w-3xl space-y-10">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4 pt-4 border-t border-wbk-lightgrey">
          <button
            ...
            className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-6 py-3 border border-wbk-lightgrey text-wbk-black hover:border-wbk-black text-xs font-medium uppercase tracking-[0.14em] transition-all cursor-pointer"
          >
            <IconPrinter size={16} />
          ...
          <Link
            href="/"
            className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-8 py-3.5 bg-wbk-black text-white hover:bg-wbk-green hover:text-wbk-black text-xs font-semibold uppercase tracking-[0.14em] transition-all shadow-sm"
          >
