              ...
              {distinctSizes.length > 2 && (
                <SwiperSlide className="!w-auto !h-full flex items-center !overflow-visible">
                  ...
                  >
                    ...
                    {activeDropdown === "size" && (
                      <div className="absolute top-full left-0 mt-1.5 z-50 bg-wbk-white border border-wbk-lightgrey/80 shadow-2xl p-2 min-w-[190px] rounded-none max-h-72 overflow-y-auto custom-scrollbar">
