      ...
      <section className="border-b border-wbk-lightgrey/60 bg-[#FBF9F8] py-16 sm:py-20">
        <Container size="xl">
          <div className="max-w-3xl">
            ...
            <div className="mt-8 flex flex-wrap items-center gap-6 p-4 bg-white rounded-none border border-wbk-lightgrey max-w-lg shadow-xs">
      ...
      <Container size="xl" className="pt-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 pt-8">
          {filteredReviews.map((item) => (
            <div
              key={item.id}
              className="bg-white p-7 rounded-none border border-wbk-lightgrey/80 shadow-xs hover:shadow-md transition-all flex flex-col justify-between"
            >
              <div>
