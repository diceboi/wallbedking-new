      ...
      <Container size="xl" className="pt-16 sm:pt-20">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12">
          ...
          <div className="lg:col-span-8 space-y-6">
            <div className="relative aspect-video w-full rounded-3xl overflow-hidden bg-black shadow-xl border border-wbk-lightgrey/80">
              <iframe
            ...
            <div className="bg-[#FBF9F8] p-6 rounded-2xl border border-wbk-lightgrey/80">
          ...
          <div className="lg:col-span-4 space-y-4">
            ...
            <div className="mt-8 p-6 rounded-3xl bg-white border border-wbk-lightgrey shadow-xs text-center space-y-3">
